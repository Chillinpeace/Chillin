...
return ( <div className="app-shell"> <header className="topbar"> <div className="brand"> <div className="brand-mark">P</div> <div> <h1>Peacely</h1> <span>PG Management</span> </div> </div>
...
return ( <div className="dashboard"> <section className="welcome-card"> <div> <p className="eyebrow">WELCOME BACK</p> <h2>Good day, Admin 👋</h2> <p className="welcome-text">
Manage your property, rooms, tenants and payments from one place. </p> </div>
...
return ( <div className="stat-card"> <div className="stat-top"> <span>{title}</span> <div className="stat-icon">{icon}</div> </div>
...
return ( <div className="property-page"> <div className="page-header"> <div> <p className="eyebrow">PROPERTY</p> <h2>Property Setup</h2> <p className="page-description">
Add your PG or property details. </p> </div> </div>
...
return (
<div className={`form-field ${full ? "full" : ""}`}> <label>{label}</label>
...
return ( <div className="rooms-page"> <div className="page-header"> <div> <p className="eyebrow">ROOMS & BEDS</p> <h2>Rooms & Beds</h2> <p className="page-description">
Manage rooms, beds and availability. </p> </div>
...
return ( <div className="tenant-list-page"> <div className="page-header"> <div> <p className="eyebrow">TENANTS</p> <h2>Tenants</h2> <p className="page-description">
Manage admissions and tenant information. </p> </div>
...
return ( <div className="rent-page"> <div className="page-header"> <div> <p className="eyebrow">
FINANCE </p>
...
return ( <div className="coming-soon"> <div className="coming-icon">
🚧 </div>
